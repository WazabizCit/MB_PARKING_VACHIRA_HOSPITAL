...
public class Result_action_mobile_logout {
    ...
    @SerializedName("data")
    @Expose
    private Sub_data_action_mobile_logout data;
    ...
    public Sub_data_action_mobile_logout getData() {
        return data;
    }

    public void setData(Sub_data_action_mobile_logout data) {
        this.data = data;
    }
