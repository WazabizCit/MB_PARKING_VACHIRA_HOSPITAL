...
import com.example.mb_parking_vachira_hospital.adapter.History_Estamp_Data_Adapter;
...
public class HistoryEstampMainActivity extends ImportantMethod {
    ...
    ListView listview;
    History_Estamp_Data_Adapter adapter;
    ArrayList<History_data_estamp_dao> mlist;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_history_estamp_main);
        ...
        toolbar.setTitle("ประวัติประทับตรา");
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == android.R.id.home) {
            ...
            Intent intent = new Intent(HistoryEstampMainActivity.this, MainActivity.class);
    ...
    private void getListHistory() {
        ...
        dao.open();
        ArrayList<History_data_estamp_dao> mlist = dao.getDataHistory();
        dao.close();
        if (mlist.size() == 0) {
            ...
            adapter = new History_Estamp_Data_Adapter(this, mlist);
